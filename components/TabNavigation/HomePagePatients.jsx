...
useFocusEffect(
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={{ flexDirection: 'row', marginVertical: 15, justifyContent: 'space-between' , marginHorizontal:10, marginTop:45}}>
        ...
        <View style={{ flexDirection: 'row', gap: 15 }}>
          <TouchableOpacity>
            <Image source={require("../../assets/notify.png")} resizeMode='cover'/>
          </TouchableOpacity>
      ...
      <ScrollView>
        <View style={{ marginVertical: 24, gap: 16,marginHorizontal:10, }}>
          ...
          <ScrollView horizontal={true}>
            <View style={{ flexDirection: 'row', gap: 8, borderRadius: 5, backgroundColor:"#d9d9d9"}}>
          ...
          <ScrollView horizontal>
            {
              doctors?.length >0 && doctors.map((item)=>(
                <View key={item._id} style={{ flexDirection: 'row', gap: 10, borderRadius: 5, borderColor: '#D9D9D980', borderWidth: 1 , paddingHorizontal:10, paddingVertical:16,gap:16}}>
