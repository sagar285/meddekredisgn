          ...
          <View style={{ borderWidth: 1, borderColor: '#D9D9D961', borderRadius: 5, padding: 16, gap: 16 }}>
            <View style={{ flexDirection: 'row', gap: 15 }}>
              ...
              <View style={{ gap: 3, width: '90%' }}>
                <Text style={{ color: '#1F51C6', fontSize: 10, fontWeight: '600', backgroundColor: '#108ED647', paddingHorizontal: 10, paddingVertical: 6, borderRadius: 5, width: '35%' }}>Appointment {item?.doctorid?.acceptAppointments}</Text>
