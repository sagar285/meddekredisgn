                ...
                upcomingappointments.length > 0  ?  upcomingappointments.map((item)=>(
                 <View key={item} style={{ gap: 16 }}>
                    <View style={{ flexDirection: 'row', gap: 15 }}>
                        ...
                        <View style={{ gap: 3 }}>
                            <Text style={{ color: '#1F51C6', fontSize: 10, fontWeight: '600', backgroundColor: '#108ED647', paddingHorizontal: 10, paddingVertical: 6, borderRadius: 5 }}>{item?.doctorid?.acceptAppointments}</Text>
