      ...
      <ScrollView>
        <View style={{ marginHorizontal: 10, marginVertical: 16, gap: 16 }}>
          ...
          <View style={{flexDirection:'row', gap:8, flexWrap:'wrap',}}> 
            ...
            style={{ borderRadius: 5, borderWidth: 1, borderColor: '#D9D9D982', width: 121, }}>
              <Image source={{uri:item.imgurl}} resizeMode='cover' style={{ width: 121, height: 85 }} />
              <View style={{ flexDirection: 'row', paddingVertical: 8, paddingHorizontal: 5, justifyContent: 'space-between',}}>
                <View>
                  ...
                  <Text style={{ color: '#706D6D', fontSize: 8, fontWeight: '500', }}>128kb</Text>
                </View>
