...
Isuserexist()
  ...
  return (
    ...
    >
      <View style={{ marginHorizontal: 22,  height:'70%'}}>
        ...
        <View style={{ marginTop: 70,backgroundColor:"#FFFFFF"}}>
      ...
      <View style={{ backgroundColor: '#FFFFFF', paddingHorizontal: 32, paddingVertical: 16,  borderTopLeftRadius: 20, borderTopRightRadius: 20, gap: 16, height:'35%' }}>
